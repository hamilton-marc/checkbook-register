 ...
 * Window>Preferences>Java>Code Generation>Code and Comments
 */
public class ReportCompletionPage extends WizardPage implements IExtendedWizardPage
{
     ...
     * @param arg0
     */
    public ReportCompletionPage(String strPageName)
    {
        super(strPageName);
    }
