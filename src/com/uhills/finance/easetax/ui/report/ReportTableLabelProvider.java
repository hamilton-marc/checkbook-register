 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ReportTableLabelProvider implements ITableLabelProvider
{
    private ReportDataContentProvider          m_contentProvider;

    private ReportDataContentProvider getContentProvider()
    {
        if (m_contentProvider == null)
            m_contentProvider = new ReportDataContentProvider(null);
